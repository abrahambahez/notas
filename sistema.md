...
[^1]: Aún no me queda claro cómo se determinan los limites del sistema. Por ejemplo, no sé si el conjunto de miembros es considerado un conjunto finito, con una extensión definida, pero es posible que este límite depende de la definición del sistema para un fin analítico determinado
