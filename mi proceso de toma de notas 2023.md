...
El texto final y la nota son dos momentos separados. Forzar la nota al texto final debilita su mayor ventaja: **ser un dispositivo para pensar mejor** ([[las notas son para pensar]]).

## Proceso actual

Creo que un sistema mínimo viable de [[gestión del conocimiento]] tiene un flujo como este:

```mermaid
graph TD
    Explorar <--> Aprender <--> Pensar <--> Crear
```
...
- [[lectura incremental]] para cosas que sé que vale la pena explorar
    ...
    - Después de años ya no creo que las notas deban ser como la prosa final. Las notas son un proceso totalomente independiente a la prosa publicable. **Las notas son sólo para pensar**.
- [[inbox de escritura]] basado en extractos procesados de cada [[nota diaria]]
...
- Sesiones de escritura para publicar
    - [[cómo crear índices argumentales con notas atómicas]]
    - Idealmente debería ser un proceso espaciado, como en la [[guía para la escritura académica según @ahrens2017]]
    - aquí me baso en [[estrategia de escritura rápida]] (falta elaboración en esa nota)
