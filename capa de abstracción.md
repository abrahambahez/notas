Una capa de abstracción (también llamado *nivel de indirección*) es un [[constructo teórico]] que se refiere a la separación de procesos relacionados con un fenómeno para poder reusar sus características formales en múltiples contextos.
