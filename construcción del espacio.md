...
No todo el espacio sociopolítico es [[territorio]]. Se han pensado otras formas de entender y definir esas prácticas, como el caso estudiado por Hoffmann sobre la [[la visión misak de la expansión del espacio]], que es la de un *espacio disperso* donde *el pueblo está donde sus pobladores* (cfr. siguiente apartado). Usar el concepto de territorio para estas nuevas versiones debería ser considerado con cuidado, puede representar un abuso del término. <!-- --> 
